...
//         PostItem.innerHTML = `<div class="ConMyPosts-1-Header">
...
//           ${text}
//         </div>
//         <div class="ConMyPosts-1-Content-Media" id="ID-ConMyPostMedia">
//         </div>
//       </div>
...
//             <p style="margin-left: 8px;">191K</p>
//           </div>
...
//           <div id="Comment-0" class="User1">
//             <img src="../images/dong.km/Fri_5.jpg" alt="">
//             <div class="User1-Pan">
//               <div class="User1-PanCo">
//                 <div class="User1-Name">
//                   <span class="bold-text">Lionel Messi
...
//                     dõi</button>
//                 </div>
//                 <div class="User1-Comment">You are a legend!</div>
...
//                 </div>
//                 <button class="User1-Edit" onclick="clickEditDelBtn('Comment-0')">···</button>
//                 <div class="User1-Edit-Del" id="EditDelHolder">
//                   <button class="User1-Edit-Del-CS" onclick="editComment('Comment-0')">Chỉnh sửa</button>
//                   <button class="User1-Edit-Del-X" onclick="openConfirmModal('Comment-0')">Xóa</button>
//                   <input id="Flag" type="hidden" value="0" />
//                 </div>
//               </div>
//               <div class="User1-React">
...
//         // console.log(Post_Status_Text.value);
//         // console.log(imagePreviewModal);
...
//         const CMP1ContentMedia = document.getElementById("ID-ConMyPostMedia");
//         CMP1ContentMedia.appendChild(imageNode);
...
postButton.addEventListener("click", function () {
  ...
  <div class="ConMyPosts-1-Content">
    ...
    <div class="ConMyPosts-1-Content-Media">
    </div>
  </div>
  <div class="ConMyPosts-1-Com">
    <div class="ConMyPosts-1-Com-Rea">
